...
/* Font Preset
*/
static const Font_Typedef FontPresetTab[] =  
{
...
/* font in flash */
HzkFontInfo_Typedef HzkFontInfo;
...
uint8_t HZKFont_Check(void)
{
    ...
    ret = QSPI_Flash_Read((uint8_t *)&HzkFontInfo, HZKFONT_ADDR, sizeof(HzkFontInfo_Typedef));
...
Font_Typedef GetFontPreset(uint8_t preset)
{
