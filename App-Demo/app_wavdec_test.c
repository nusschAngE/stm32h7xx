...
DIR AudioDir;
bool fileEnd = FALSE;
WavHeader_Typedef WavHeader;
FileList_Typedef FiltList;
AudioDecode_InitTypedef AudDecInit;
...
void WavDecode_Test(void)
{
    ...
    AudBuffer0 = (uint8_t*)myMalloc(MLCSRC_AXISRAM, AUD_BUFF_SIZE);
    AudBuffer1 = (uint8_t*)myMalloc(MLCSRC_AXISRAM, AUD_BUFF_SIZE);
