...
extern uint8_t Wav_GetHeader(WavHeader_Typedef *header, uint8_t *pData, uint32_t pSize, uint32_t *bDecode);
extern uint8_t Wav_AudioDataProc(WavHeader_Typedef *header, uint8_t *pBuff, uint32_t buffSize, const uint8_t *pData, uint32_t dataSize, uint32_t *bFill);
