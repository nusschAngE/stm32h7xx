...
typedef struct
{
    ...
    uint8_t (*DecodeInit)(AudioDecode_InitTypedef *DecInfo);
...
extern uint8_t Audio_DecodeInit(AudioDecode_InitTypedef *Init);
...
extern int16_t Audio_GetError(void);
extern int16_t Audio_GetState(void);

/* Decoder IC */
extern uint8_t Audio_DecoderStart(void);
extern uint8_t Audio_DecoderStop(void);
#if 0
extern uint8_t AudioDrv_Register(AudioDec_DrvTypedef *drv);
extern void AudioDrv_DeRegister(AudioDec_DrvTypedef *drv);
#endif
