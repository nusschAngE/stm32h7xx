...
/********* VALUE ***********************/
static ATKUart_DevTypedef EspUartDev = 
{
    UART_MODE_TX_RX,
    115200,
    esp_RxParser,
...
/* IP Connect manage */
static IPConnect_Typedef ipConnected[4];
...
uint8_t ESP8266_SearchAP(APInfo_Typedef **apInfo, uint8_t *listNbr, uint8_t maxNbr)
{
    return (0);
}

uint8_t ESP8266_ClearAPList(APInfo_Typedef **apInfo, uint8_t listNbr)
{
    return (0);
}
...
uint8_t ESP8266_GetConnectedIP(IPConnect_Typedef **ip)
{
    return (0);
}
